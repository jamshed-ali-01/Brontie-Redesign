...
export default function ChangePasswordPage() {
  ...
  useEffect(() => {
    ...
    const storedEmail = localStorage.getItem('cafe-email');
    if (storedEmail) {
      setEmail(storedEmail);
    } else {
      // If no email stored, redirect to login
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/auth/cafe-change-password', {
        method: 'POST',
        headers: {
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-teal-500 focus:border-teal-500 text-black pr-10"
