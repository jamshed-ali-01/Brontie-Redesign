    ...
    return (
      <CafeDashboardLayout cafeName="Loading..." ownerName="">
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
          ...
          <h3 className="text-[16px] font-bold text-gray-800 tracking-wide">Loading vouchers...</h3>
          <p className="mt-2 text-[12px] text-gray-500 font-medium">Fetching active and redeemed vouchers.</p>
        </div>
      </CafeDashboardLayout>
    );
  }
