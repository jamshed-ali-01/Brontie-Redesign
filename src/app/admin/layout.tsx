...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navigation = [
    ...
    {
      name: 'Manual Rankings',
      href: '/admin/rankings',
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.945a1 1 0 00.95.69h4.15c.969 0 1.371 1.24.588 1.81l-3.36 2.44a1 1 0 00-.364 1.118l1.287 3.945c.3.92-.755 1.688-1.54 1.118l-3.36-2.44a1 1 0 00-1.176 0l-3.36 2.44c-.785.57-1.84-.198-1.54-1.118l1.287-3.945a1 1 0 00-.364-1.118L2.03 9.372c-.783-.57-.38-1.81.588-1.81h4.15a1 1 0 00.95-.69L8.999 3.826z" />
        </svg>
      )
    },
    {
    ...
    // YEH NAYA LINK ADD KIYA HAI - Message Templates
    {
      name: 'Message Templates',
      href: '/admin/MessageTemplete',
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 3a1 1 0 00-1 1v2a1 1 0 001 1h2a1 1 0 001-1V4a1 1 0 00-1-1h-2zM5 7a1 1 0 00-1 1v10a2 2 0 002 2h6a1 1 0 001-1v-3a1 1 0 011-1h3a1 1 0 001-1V8a1 1 0 00-1-1H5z" />
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h6m8 0a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
      )
    },
    {
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-56 bg-white flex flex-col transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        ...
        <div className="flex items-center justify-between h-14 px-4 border-b border-gray-100">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-sm font-semibold text-gray-900">Brontie</span>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
          ...
          <div className="space-y-0.5">
            {navigation.map((item) => {
              const isActive = pathname === item.href ||
                ...
                (item.name === 'Message Templates' && pathname.startsWith('/admin/MessageTemplete'));
              return (
                <Link
                  key={item.name}
                  href={item.href}
                  ...
                  onClick={() => setSidebarOpen(false)}
                >
                  <span className={`mr-3 ${isActive ? 'text-amber-700' : 'text-gray-500 group-hover:text-amber-600'
                    }`}>
                    {item.icon}
                  </span>
                  ...
                  <span className="text-sm text-gray-600 capitalize">
                    {pathname.includes('/analytics/') ? 'Analytics' :
                      pathname === '/admin/master-revenue' ? 'Master Revenue' :
                        pathname.includes('/MessageTemplete') ? 'Message Templates' :
                          pathname === '/admin/maintenance' ? 'Maintenance Settings' :
