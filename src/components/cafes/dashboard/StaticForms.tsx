...
export function ValidateVoucherBlock() {
  return (
    <div className="mb-6 mt-4">
      <h2 className={`text-[30px] text-[#1c1c1c] tracking-tight mb-2 ${lobster.className}`}>
        Validate Voucher Code
      </h2>
      <p className="text-[12px] font-medium text-[#6ca3a4] mb-5">
        ...
        <form className="flex flex-col gap-4">
          <div className="flex flex-col gap-3">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-0">
              <label className="text-[12px] font-bold text-gray-600 tracking-wider uppercase">Voucher Code</label>
              <span className="text-[10px] sm:text-[11px] w-fit uppercase tracking-wider font-bold text-[#6ca3a4] bg-[#e0f2f1] px-2 py-1 rounded-lg">
            ...
            <div className="flex-1 w-full bg-[#f8f9fa] rounded-xl flex items-center px-4 h-12  border border-gray-100 focus-within:border-[#6ca3a4] transition-colors">
              ...
              <input 
                ...
                className="bg-transparent border-none outline-none text-sm text-gray-800 font-medium placeholder:text-gray-400 w-full tracking-wide  max-md:h-10"
              />
            </div>
          <button type="button" className="w-full md:w-auto self-start bg-[#6ca3a4] hover:bg-[#568586] text-white px-6 h-12 rounded-xl text-[14px] font-semibold transition-colors flex items-center justify-center shadow-sm">
            Validate
            <ArrowRight className="size-4 sm:size-5 ml-2" color='#ffff' />
          </button>
            </div>
          </div>
        </form>
...
export function FeedbackBlock() {
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-gray-50 p-4 sm:p-6 relative">
