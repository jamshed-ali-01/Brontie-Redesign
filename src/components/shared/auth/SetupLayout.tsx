  ...
  return (
    <div className="min-h-screen flex flex-col font-sans overflow-x-hidden bg-[#f4c24d]">
      ...
      <main className="flex-1 relative flex flex-col items-center">
        ...
        <div className="absolute top-[265px] left-[50%] -translate-x-1/2 w-[250%] md:w-[200%] h-[3000px] bg-[#fef6eb] rounded-t-[100%] z-0 rounded-b-none"></div>
        ...
        <div className={`relative z-20 w-full ${maxWidth} px-7 pt-10 flex flex-col items-center`}>
           ...
           {(headingPart1 || headingPart2) && (
             <div className="text-center mb-10 px-8 relative z-30">
                <h1 className={`text-[36px] md:text-[42px] leading-[1.2] ${lobster.className} drop-shadow-sm text-center ${inlineHeading ? 'whitespace-nowrap' : 'flex flex-col items-center justify-center'}`}>
                ...
                {subtitle && (
                  <p className="text-black text-[11px] font-medium max-w-md mx-auto mt-3 leading-relaxed opacity-90">
                    {subtitle}
                  </p>
                )}
             </div>
