        ...
        <table className="w-full text-left border-collapse min-w-[800px]">
          <thead>
            <tr className="border-b border-gray-100">
              <th className="px-6 py-5 text-[11px] font-bold text-gray-400 tracking-wider uppercase bg-white">ITEM</th>
              <th className="px-6 py-5 text-[11px] font-bold text-gray-400 tracking-wider uppercase bg-white">VALUE</th>
              <th className="px-6 py-5 text-[11px] font-bold text-gray-400 tracking-wider uppercase bg-white">LOCATION</th>
              <th className="px-6 py-5 text-[11px] font-bold text-gray-400 tracking-wider uppercase bg-white">PURCHASE DATE/TIME</th>
              <th className="px-6 py-5 text-[11px] font-bold text-gray-400 tracking-wider uppercase bg-white">REDEMPTION DATE/TIME</th>
              <th className="px-8 py-5 text-[11px] font-bold text-gray-400 tracking-wider uppercase bg-white text-right">CODE</th>
            </tr>
          </thead>
              ...
              <tr key={row.id} className="hover:bg-gray-50/50 transition-colors">
                <td className="px-6 py-4">
                  <div className="flex items-center space-x-4">
                    <div className="w-10 h-10 rounded-full overflow-hidden shrink-0 border border-gray-100 shadow-sm p-0.5 bg-white">
                       <img 
                          src={row.itemImage} 
                          alt={row.itemName} 
                    ...
                    <span className="text-[13px] font-bold text-gray-900">{row.itemName}</span>
                  </div>
                </td>
                <td className="px-6 py-4 text-[13px] font-bold text-[#6ca3a4]">
                  €{row.value.toFixed(2)}
                </td>
                <td className="px-6 py-4 text-[13px] font-bold text-[#879bb1]">
                  {row.location}
                </td>
                ...
                <td className="px-8 py-4 text-right">
                  <span className="inline-flex bg-teal-50 text-[#6ca3a4] px-3 py-1.5 rounded-lg text-xs font-bold border border-teal-100">
                    {row.code}
                  </span>
                </td>
              </tr>
