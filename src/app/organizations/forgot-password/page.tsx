// src\app\organizations\forgot-password\page.tsx
'use client';
    ...
    try {
      ...
      if (response.ok) {
        if (data.emailFound === false) {
          setError('No organization account found with this email.');
        } else {
          setSuccess(true);
        }
      } else {
          ...
          <div className="text-center">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <p className="text-gray-600 mb-6">
                ...
                Please check your organization email and follow the instructions to reset your password.
              </p>
              <div className="space-y-4">
                ...
                >
                  <span className="text-white">Back to Organization Login</span>
                </Link>
                <button
                  onClick={() => {
                    setSuccess(false);
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Enter your organization email address to receive a password reset link.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Use the email associated with your organization account
                </p>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <div className="text-center">
                <p className="text-xs text-gray-500">
                  ...
                  <a
                    href="mailto:organizations@brontie.com"
                    className="text-blue-600 hover:text-blue-500 transition-colors"
                  >
                    organizations@brontie.com
                  </a>
                </p>
              </div>
            </div>
