...
export default function PosSystemTab({ isSquareConfigured, onConnectSquare }: PosSystemTabProps) {
  return (
    <div className="bg-white rounded-[24px] p-8 max-w-3xl shadow-[0_4px_24px_rgba(0,0,0,0.02)]">
      <h3 className="text-[28px] font-bold text-gray-900 mb-3" style={{ fontFamily: 'var(--font-lobster), cursive' }}>
      ...
      <p className="text-gray-600 text-[15px] leading-relaxed mb-8">
        ...
        <br />
        <span className="text-[#6ca3a4] text-sm mt-3 inline-block">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Square App */}
        <div className="bg-[#fffdf8] rounded-2xl p-8 flex flex-col items-center justify-center border border-[#fef6eb] aspect-square transition-transform hover:scale-105">
          <div className="flex-1 flex items-center justify-center">
            <img src="/images/square-logo.png" alt="Square" className="h-10 object-contain mix-blend-multiply opacity-80" onError={(e) => {
        ...
        {/* Clover App */}
        <div className="bg-[#fcfdfd] rounded-2xl p-8 flex flex-col items-center justify-center border border-gray-50 aspect-square transition-transform hover:scale-105">
          <div className="flex-1 flex items-center justify-center">
            <img src="/images/clover-logo.png" alt="Clover" className="h-8 object-contain mix-blend-multiply opacity-80" onError={(e) => {
        ...
        {/* Toast App */}
        <div className="bg-[#fffbfb] rounded-2xl p-8 flex flex-col items-center justify-center border border-orange-50 aspect-square transition-transform hover:scale-105">
          <div className="flex-1 flex items-center justify-center">
            <img src="/images/toast-logo.png" alt="Toast" className="h-8 object-contain mix-blend-multiply opacity-80" onError={(e) => {
